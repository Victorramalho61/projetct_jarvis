...
app = FastAPI(title="Jarvis Core Service")
...
app.include_router(health_router)              # /health, /ready (Docker healthcheck)
app.include_router(health_router, prefix="/api")  # /api/health, /api/ready (público via Kong)
app.include_router(auth_router, prefix="/api")
app.include_router(users_router, prefix="/api")
app.include_router(admin_router, prefix="/api")
app.include_router(notifications_router, prefix="/api")  # /api/notifications/summary
