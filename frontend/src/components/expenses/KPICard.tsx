    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 truncate">{title}</span>
        </div>
      ...
      {/* Value */}
      <div>
        <p className="text-[22px] font-bold leading-none text-gray-900 dark:text-white">{FMT_BRL(value)}</p>
        {subtitle && (
