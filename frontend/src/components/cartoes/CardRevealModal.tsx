...
export default function CardRevealModal({ card, token, onClose }: Props) {
  ...
  // Formulário — estado sempre limpo ao abrir (não persiste entre aberturas)
        ...
        <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-5 py-4">
          <div>
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">
              {state === "revealed" ? "Dados do Cartão" : "Solicitar Acesso ao Cartão"}
            </h2>
          ...
          {(state === "form" || state === "rejected") && (
            <button
              onClick={handleClose}
              className="h-8 w-8 grid place-items-center rounded-md text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800"
            >
