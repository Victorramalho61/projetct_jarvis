...
setup_log_forwarding("satisfacao-service")
...
async def lifespan(app: FastAPI):
    _logger.info("Satisfacao Service starting up")
    try:
    ...
    yield
    _logger.info("Satisfacao Service shutting down")
    try:
...
app = FastAPI(title="Jarvis Satisfação Service", lifespan=lifespan)
