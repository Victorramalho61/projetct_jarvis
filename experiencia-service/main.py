...
setup_log_forwarding("experiencia-service")
...
async def lifespan(app: FastAPI):
    _logger.info("Experiencia Service starting up")
    try:
    ...
    yield
    _logger.info("Experiencia Service shutting down")
    try:
...
app = FastAPI(title="Jarvis Experiência Service", lifespan=lifespan)
